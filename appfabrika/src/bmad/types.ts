...
export const BMAD_PHASES: PhaseDefinition[] = [
  {
    ...
    workflows: [
      ...
      {
        id: 'party-mode-analysis',
        name: 'Party Mode: Analiz Tartışması',
        command: '/bmad-party-mode',
        agent: 'All',
        agentEmoji: '🎉',
        required: true,
        description: 'Tüm uzmanların analiz bulgularını tartışması',
        stepCount: 1,
        path: 'core/workflows/party-mode',
      },
    ],
  },
  {
    ...
    workflows: [
      ...
      },
      {
        ...
        name: 'Wireframe Oluştur',
        command: '/bmad-bmm-create-excalidraw-wireframe',
        agent: 'Sally',
        agentEmoji: '📐',
        required: true,
        description: 'Excalidraw wireframe diyagramları',
        stepCount: 1,
        path: 'bmm/workflows/excalidraw-diagrams/create-wireframe',
      },
      {
        id: 'party-mode-planning',
        name: 'Party Mode: Planlama Tartışması',
        command: '/bmad-party-mode',
        agent: 'All',
        agentEmoji: '🎉',
        required: true,
        description: 'Tüm uzmanların PRD ve UX planını tartışması',
        stepCount: 1,
        path: 'core/workflows/party-mode',
      },
    ],
  },
  {
    ...
    workflows: [
      ...
      },
      {
        ...
        agentEmoji: '⚔️',
        required: true,
        description: 'Agresif eleştiri - tüm dokümanları sorgula',
        stepCount: 1,
        path: 'core/tasks/review-adversarial-general',
      },
      {
        id: 'quality-validation',
        name: 'Kalite Validasyonu',
        command: '/bmad-quality-validation',
        agent: 'Quinn',
        agentEmoji: '✅',
        required: true,
        description: 'PRD, Mimari, Story kalite skorları',
        stepCount: 1,
        path: 'custom/quality-validation',
      },
      {
        id: 'create-architecture-diagram',
        name: 'Mimari Diyagram Oluştur',
        command: '/bmad-bmm-create-excalidraw-diagram',
        agent: 'Winston',
        agentEmoji: '📊',
        required: true,
        description: 'Excalidraw sistem mimari diyagramı',
        stepCount: 1,
        path: 'bmm/workflows/excalidraw-diagrams/create-diagram',
      },
      {
        id: 'create-flowchart',
        name: 'Akış Diyagramı Oluştur',
        command: '/bmad-bmm-create-excalidraw-flowchart',
        agent: 'Winston',
        agentEmoji: '📈',
        required: true,
        description: 'Excalidraw iş akışı diyagramı',
        stepCount: 1,
        path: 'bmm/workflows/excalidraw-diagrams/create-flowchart',
      },
      {
        id: 'create-dataflow',
        name: 'Veri Akış Diyagramı Oluştur',
        command: '/bmad-bmm-create-excalidraw-dataflow',
        agent: 'Winston',
        agentEmoji: '🔄',
        required: true,
        description: 'Excalidraw data flow diyagramı',
        stepCount: 1,
        path: 'bmm/workflows/excalidraw-diagrams/create-dataflow',
      },
      {
        id: 'create-erd',
        name: 'ERD Diyagramı Oluştur',
        command: '/bmad-bmm-create-excalidraw-diagram',
        agent: 'Winston',
        agentEmoji: '🗄️',
        required: true,
        description: 'Excalidraw entity-relationship diyagramı',
        stepCount: 1,
        path: 'bmm/workflows/excalidraw-diagrams/create-diagram',
      },
      {
        id: 'party-mode-solutioning',
        name: 'Party Mode: Çözüm Tartışması',
        command: '/bmad-party-mode',
        agent: 'All',
        agentEmoji: '🎉',
        required: true,
        description: 'Tüm uzmanların mimari ve epic/story planını tartışması',
        stepCount: 1,
        path: 'core/workflows/party-mode',
      },
    ],
  },
  {
    ...
    workflows: [
      ...
      },
      {
        ...
        agentEmoji: '📚',
        required: true,
        description: 'Proje dokümantasyonu oluşturma',
        stepCount: 3,
        path: 'bmm/workflows/document-project',
      },
      {
        id: 'code-scaffolding',
        name: 'Kod Scaffolding',
        command: '/bmad-code-scaffolding',
        agent: 'Amelia',
        agentEmoji: '🏗️',
        required: true,
        description: 'Otomatik proje yapısı ve kod üretimi',
        stepCount: 1,
        path: 'custom/code-scaffolding',
      },
      {
        id: 'quick-spec',
        name: 'Quick Spec',
        ...
        agentEmoji: '⚡',
        required: false,
        description: 'Hızlı teknik spec oluşturma',
        stepCount: 4,
        path: 'bmm/workflows/bmad-quick-flow/quick-spec',
      },
      {
        id: 'quick-dev',
        name: 'Quick Dev',
        ...
        agentEmoji: '⚡',
        required: false,
        description: 'Hızlı geliştirme rehberi',
        stepCount: 6,
        path: 'bmm/workflows/bmad-quick-flow/quick-dev',
      },
      {
        id: 'editorial-review',
        name: 'Editorial Review',
        command: '/bmad-editorial-review',
        agent: 'TechWriter',
        agentEmoji: '✍️',
        required: false,
        description: 'Yazım ve yapı kalite kontrolü',
        stepCount: 1,
        path: 'core/tasks/editorial-review',
      },
      {
        id: 'party-mode-retrospective',
        name: 'Party Mode: Retrospektif Tartışması',
        command: '/bmad-party-mode',
        agent: 'All',
        agentEmoji: '🎉',
        required: true,
        description: 'Tüm uzmanların uygulama sürecini değerlendirmesi',
        stepCount: 1,
        path: 'core/workflows/party-mode',
      },
    ],
